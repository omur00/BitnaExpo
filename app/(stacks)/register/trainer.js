                ...
                <React.Fragment key={step.number}>
                  <View className="flex-row items-center gap-2">
                    <View
                      ...
                      <Text
                        className={`text-center font-arabic-semibold ${
                          currentStep >= step.number ? 'text-white' : 'text-gray-500'
                        }`}
                        style={{ lineHeight: 24 }} // Add this to ensure vertical centering
                      >
                        {step.number}
                      </Text>
                    </View>
                          ...
                          <View className="gap-3">
                            ...
                            <View className="flex-row gap-3">
                              ...
                              <View className="flex-1 gap-1">
                                ...
                                <TextInput
                                  ...
                                  onChangeText={(value) =>
                                    handleCourseChange(index, 'sessions', value)
                                  }
                                  placeholder="8"
                                  keyboardType="numeric"
                                  className="w-full rounded-lg border border-gray-300 bg-white p-3 font-arabic-regular text-sm text-gray-900"
                            ...
                            <View className="flex-row gap-3">
                              <View className="flex-1 gap-1">
                                ...
                                <TextInput
                                  value={course.price}
                                  onChangeText={(value) =>
                                    handleCourseChange(index, 'price', value)
                                  }
                                  placeholder="1000"
                                  keyboardType="numeric"
                                  className="w-full rounded-lg border border-gray-300 bg-white p-3 font-arabic-regular text-sm text-gray-900"
                              ...
                              <View className="flex-1 gap-1">
                                ...
                                <Picker
                                  ...
                                  value={course.level}
                                  onValueChange={(value) =>
                                    handleCourseChange(index, 'level', value)
                                  }
                            ...
                            <View className="gap-1">
                              ...
                              <TextInput
                                ...
                                multiline
                                numberOfLines={3}
                                className="h-32 w-full rounded-lg border border-gray-300 bg-white p-3 font-arabic-regular text-sm text-gray-900"
                                textAlign="right"
                                textAlignVertical="top"
                              />
                            </View>
                              ...
                              <View className="gap-2">
                                {course.includes.map((include, includeIndex) => (
                                  <View key={includeIndex} className="flex-row gap-2">
                                    <TextInput
                                      ...
                                      className="flex-1 rounded-lg border border-gray-300 bg-white p-3 font-arabic-regular text-sm text-gray-900"
                                      textAlign="right"
                                    />
                                    <TouchableOpacity
                                ...
                                {course.includes.length === 0 && (
                                  <View className="items-center py-3">
                                    ...
                                    <Text className="mt-1 font-arabic-regular text-xs text-gray-500">
                                      لا توجد عناصر مضافة
                                    </Text>
                                  </View>
                                )}
