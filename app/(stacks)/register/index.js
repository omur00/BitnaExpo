  ...
  <ScrollView className="flex-1 bg-gray-50" showsVerticalScrollIndicator={false}>
    <View className="p-6">
      ...
      <View className="mb-8 gap-2">
        <Text className="font-arabic-regular text-center text-sm text-gray-600">اختر نوع الحساب الذي ترغب في إنشائه</Text>
      </View>
        ...
        <TouchableOpacity
          ...
          <View className="mb-4 flex-row items-center justify-between">
            <View className="flex-row items-center gap-3">
              ...
              <Text className="font-arabic-bold text-base text-[#1E2053]">متجر / تاجر</Text>
            </View>
            <View
          ...
          <View className="gap-2">
            <View className="flex-row items-center gap-2">
              ...
              <Text className="font-arabic-regular text-xs text-gray-600">إضافة منتجات وخدمات</Text>
            </View>
            <View className="flex-row items-center gap-2">
              <Ionicons name="checkmark-circle-outline" size={20} color="#10B981" />
              <Text className="font-arabic-regular text-xs text-gray-600">إدارة الطلبات والمبيعات</Text>
            </View>
            <View className="flex-row items-center gap-2">
              <Ionicons name="checkmark-circle-outline" size={20} color="#10B981" />
              <Text className="font-arabic-regular text-xs text-gray-600">عرض المتجر على المنصة</Text>
            </View>
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <View className="mb-4 flex-row items-center justify-between">
            <View className="flex-row items-center gap-3">
              ...
              <Text className="font-arabic-bold text-base text-[#1E2053]">مدرب / مقدم خدمة</Text>
            </View>
            <View
          ...
          <View className="gap-2">
            <View className="flex-row items-center gap-2">
              <Ionicons name="checkmark-circle-outline" size={20} color="#10B981" />
              <Text className="font-arabic-regular text-xs text-gray-600">إنشاء حصص وجدول تدريبي</Text>
            </View>
            <View className="flex-row items-center gap-2">
              <Ionicons name="checkmark-circle-outline" size={20} color="#10B981" />
              <Text className="font-arabic-regular text-xs text-gray-600">إدارة الحجوزات والمدفوعات</Text>
            </View>
            <View className="flex-row items-center gap-2">
              <Ionicons name="checkmark-circle-outline" size={20} color="#10B981" />
              <Text className="font-arabic-regular text-xs text-gray-600">التواصل مع المتدربين</Text>
            </View>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity
        ...
        <Text className="font-arabic-regular text-sm text-gray-500">العودة</Text>
      </TouchableOpacity>
    </View>
  </ScrollView>
);
