...
export default function UserApplication() {
  ...
  const renderWorkHours = () => {
    if (profileType !== 'merchant' || !profile.workHours) {
      return <Text className="text-gray-500">غير محدد</Text>;
    }
    ...
    try {
      ...
      return (
        <View className="space-y-4">
          ...
          {workHours.from && workHours.to && (
            <View>
              <Text className="mb-2 text-sm font-semibold text-gray-700">ساعات العمل العادية</Text>
              <View className="flex-row justify-between">
                <Text className="text-gray-600">من</Text>
                <Text className="font-medium text-gray-900">{workHours.from}</Text>
              </View>
              <View className="mt-1 flex-row justify-between">
                <Text className="text-gray-600">إلى</Text>
                <Text className="font-medium text-gray-900">{workHours.to}</Text>
              </View>
      ...
      return <Text className="text-red-500">تنسيق غير صحيح</Text>;
    }
  };
    ...
    if (!imageUrl) {
      return (
        <View className="items-center justify-center rounded-lg bg-gray-100 p-8">
          <Ionicons name="image-outline" size={48} className="mb-2 text-gray-400" />
          <Text className="text-sm text-gray-500">لا يوجد {title}</Text>
        </View>
      );
    }
    ...
    return (
      <View className="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <TouchableOpacity onPress={() => setSelectedImage(imageUrl)}>
          <Image source={{ uri: imageUrl }} className="h-48 w-full rounded-lg" contentFit="cover" />
        </TouchableOpacity>
      </View>
    );
  };
  ...
  const renderGallery = () => {
    if (!profile.galleryImages || profile.galleryImages.length === 0) {
      return (
        <View className="items-center justify-center rounded-lg bg-gray-100 p-8">
          <Ionicons name="images-outline" size={48} className="mb-2 text-gray-400" />
          <Text className="text-sm text-gray-500">لا توجد صور في المعرض</Text>
        </View>
      );
    }
    ...
    if (profileType === 'merchant') {
        ...
        <>
          ...
          <View className="rounded-xl border border-gray-200 bg-white p-4">
            <View className="mb-4 flex-row items-center">
              <Ionicons name="storefront-outline" size={20} className="ml-2 text-gray-700" />
              <Text className="text-lg font-bold text-gray-900">معلومات المتجر</Text>
            </View>

            <View className="space-y-4">
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">اسم المتجر</Text>
                <Text className="font-medium text-gray-900">{profile.businessName}</Text>
              </View>

              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">الرابط المميز</Text>
                <Text className="text-gray-900">{profile.slug}</Text>
              </View>

              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">وصف النشاط</Text>
          ...
          <View className="rounded-xl border border-gray-200 bg-white p-4">
            ...
            <View className="space-y-4">
              <View>
                <Text className="text-md mb-3 font-semibold text-gray-900">الموقع</Text>
                <View className="space-y-2">
                  <View>
                    <Text className="mb-1 text-sm font-medium text-gray-700">العنوان التفصيلي</Text>
              ...
              <View>
                <View className="mb-3 flex-row items-center">
                  <Ionicons name="time-outline" size={16} className="ml-2 text-gray-700" />
                  <Text className="text-md font-semibold text-gray-900">ساعات العمل</Text>
                </View>
                <View className="space-y-1">{renderWorkHours()}</View>
              </View>
            </View>
          </View>
        </>
      ...
      return (
        <>
          ...
          <View className="rounded-xl border border-gray-200 bg-white p-4">
            <View className="mb-4 flex-row items-center">
              <Ionicons name="school-outline" size={20} className="ml-2 text-gray-700" />
              <Text className="text-lg font-bold text-gray-900">معلومات المدرب</Text>
            </View>

            <View className="space-y-4">
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">الاسم الكامل</Text>
              ...
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">التخصص</Text>
              ...
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">الوصف</Text>
                <Text className="leading-relaxed text-gray-900">
                  {profile.description || 'لا يوجد وصف'}
                </Text>
              </View>
          ...
          <View className="rounded-xl border border-gray-200 bg-white p-4">
            ...
            <View className="space-y-3">
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">المدينة</Text>
  ...
  if (!profile)
    return (
      <View className="flex-1 items-center justify-center">
        <Text className="text-gray-900">لم يتم العثور على البيانات</Text>
      </View>
    );
    ...
    <>
          ...
          {selectedImage && (
            <>
              ...
              <TouchableOpacity
                ...
                className="absolute left-4 top-10 rounded-full bg-white/20 p-2">
      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="py-3">
          ...
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center space-x-2">
              ...
              {profile.isFeatured && (
                <View className="flex-row items-center rounded-full border border-yellow-200 bg-yellow-50 px-3 py-1">
                  <Ionicons name="star-outline" size={16} className="ml-1 text-yellow-700" />
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          <View className="mb-4 flex-row items-center">
            <Ionicons name="images-outline" size={20} className="ml-2 text-gray-700" />
          ...
          <View className="space-y-4">
            ...
            {/* Gallery Images */}
            <View>
              <Text className="text-md mb-3 font-semibold text-gray-900">
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          <View className="mb-4 flex-row items-center">
            <Ionicons name="person-outline" size={20} className="ml-2 text-gray-700" />
            <Text className="text-lg font-bold text-gray-900">معلومات التواصل</Text>
          </View>

          <View className="space-y-4">
            <View className="flex-row items-center">
              <Ionicons name="call-outline" size={16} className="ml-2 text-gray-400" />
              <View className="flex-1">
                <Text className="mb-1 text-sm font-medium text-gray-700">رقم الهاتف</Text>
                <Text className="text-gray-900">{profile.phone}</Text>
              </View>
            </View>

            <View className="flex-row items-center">
              <Ionicons name="chatbubble-outline" size={16} className="ml-2 text-gray-400" />
              <View className="flex-1">
                <Text className="mb-1 text-sm font-medium text-gray-700">واتساب</Text>
                <Text className="text-gray-900">{profile.whatsapp || 'غير متوفر'}</Text>
              </View>
            </View>

            <View className="flex-row items-center">
              <Ionicons name="mail-outline" size={16} className="ml-2 text-gray-400" />
              <View className="flex-1">
            ...
            {profile.website && (
              <View className="flex-row items-center">
                <Ionicons name="globe-outline" size={16} className="ml-2 text-gray-400" />
                <View className="flex-1">
                  <Text className="mb-1 text-sm font-medium text-gray-700">الموقع الإلكتروني</Text>
                  <TouchableOpacity onPress={() => Linking.openURL(profile.website)}>
                    <Text className="break-all text-blue-600">{profile.website}</Text>
                  </TouchableOpacity>
                </View>
              </View>
            )}
            ...
            {profile.instagram && (
              <View className="flex-row items-center">
                <Ionicons name="logo-instagram" size={16} className="ml-2 text-gray-400" />
                <View className="flex-1">
                  <Text className="mb-1 text-sm font-medium text-gray-700">إنستجرام</Text>
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          <View className="mb-4 flex-row items-center">
            <Ionicons name="document-text-outline" size={20} className="ml-2 text-gray-700" />
            <Text className="text-lg font-bold text-gray-900">المستندات والتحقق</Text>
          </View>

          <View className="space-y-4">
            <View>
              <Text className="mb-1 text-sm font-medium text-gray-700">نوع المستند</Text>
              <Text className="text-gray-900">{profile.documentType}</Text>
            </View>

            <View>
              <Text className="mb-1 text-sm font-medium text-gray-700">مستند التحقق</Text>
            ...
            {profile.additionalNotes && (
              <View>
                <Text className="mb-1 text-sm font-medium text-gray-700">ملاحظات إضافية</Text>
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          <View className="mb-4 flex-row items-center">
            <Ionicons name="person-circle-outline" size={20} className="ml-2 text-gray-700" />
          ...
          <View className="space-y-4">
            ...
            <View>
              <Text className="mb-1 text-sm font-medium text-gray-700">الدور</Text>
              <Text className="capitalize text-gray-900">{user.role}</Text>
            </View>

            <View>
              <Text className="mb-1 text-sm font-medium text-gray-700">حالة الحساب</Text>
              <View
                ...
                <Text className={`text-xs ${user.isActive ? 'text-emerald-700' : 'text-red-700'}`}>
            ...
            <View>
              <Text className="mb-1 text-sm font-medium text-gray-700">تاريخ إنشاء الحساب</Text>
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          ...
          <View className="space-y-3">
            ...
            <View className="flex-row items-center justify-between">
              ...
              <View className="flex-row items-center">
                <Ionicons name="calendar-outline" size={14} className="ml-1 text-gray-900" />
        ...
        <View className="mb-4 rounded-xl border border-gray-200 bg-white p-4">
          <View className="mb-4 flex-row items-center">
            <Ionicons name="pricetag-outline" size={20} className="ml-2 text-gray-700" />
          ...
          <View className="space-y-2">
            <View>
              ...
              <Text className="text-sm font-medium text-gray-900">{profile.category?.nameAr}</Text>
            </View>
            <View>
          ...
          <View className="mb-8 rounded-xl border border-gray-200 bg-white p-4">
            ...
            <View className="space-y-3">
              <TouchableOpacity
                ...
                className="flex-row items-center justify-center rounded-lg bg-emerald-600 px-4 py-3">
                <Ionicons
              ...
              <TouchableOpacity
                ...
                className="flex-row items-center justify-center rounded-lg bg-red-600 px-4 py-3">
                <Ionicons name="close-circle-outline" size={20} color="white" className="ml-2" />
                <Text className="text-base text-white">
